...
type Facility = "none"|"smoking"|"convenience"|"toilet";
...
const facilityLabels:Record<Facility,{label:string;query:string;icon:string}>={
  none:{label:"地点 / 路线",query:"",icon:"⌖"},smoking:{label:"吸烟所",query:"喫煙所",icon:"🚬"},convenience:{label:"便利店",query:"コンビニ",icon:"▣"},toilet:{label:"公共卫生间",query:"公衆トイレ",icon:"WC"},
};
const checklist=[
