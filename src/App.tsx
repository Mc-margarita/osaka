...
const bookings=[
  ...
  {day:"8.31",level:"已预订",title:"KOBE BEEF DINING Mouriya",time:"19:00 · 1 人",detail:"TableCheck 已确认：神户牛大腿牛排套餐 140g。费用当天到店支付；邮件菜单标签显示“午餐”，但预约日期与时间明确为 8/31 19:00。高峰时段晚餐限时 1 小时 50 分。预约邮件链接、编号及联系方式不在公开网站展示。",price:"到店支付 ¥6,950",links:[["餐厅官方页面","https://www.mouriya.co.jp/dsb"],["Google Maps","https://www.google.com/maps/search/?api=1&query=KOBE+BEEF+DINING+Mouriya"]]},
